...
<table width="100%" align="center">
  <tr>
    <td width="55%" valign="top">
      ...
      <ul>
        <li>🚀 <b>Lead Architect:</b> <a href="https://github.com/ketewodros41-star/The-Conversion-Engine">The Conversion Engine</a> — B2B Outreach Automation</li>
        <li>🧠 <b>Core Developer:</b> <a href="https://github.com/ketewodros41-star/data-agent-challenge">Oracle Forge</a> — Multi-DB Intelligence Agent</li>
